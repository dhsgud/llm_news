...
"""Script to write trend_aggregator.py file"""
...
with open('services/trend_aggregator.py', 'w', encoding='utf-8') as f:

    f.write(content)



print("??trend_aggregator.py written successfully")
...
size = os.path.getsize('services/trend_aggregator.py')
